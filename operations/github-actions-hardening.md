...
| 7. Annotate every workflow's `permissions:` block with a comment explaining each grant. | Platform team    | In progress (`platform-infra/build-push.yaml`, `deploy.yaml` done 2026-04-23; `shared-sdk-client` and runtime `ci/security` workflows updated 2026-04-26) |
